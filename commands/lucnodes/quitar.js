...
module.exports = {
    ...
    options: [
        {
            name: 'usuario',
            description: 'Elige al usuario al que quitar el dinero.',
            type: 6, //tipo usuario
            required: true
        },
        {
    ...
    run: async (client, interaction) => {
        ...
        async function eliminarmoneda() {
            await axios(`https://bots.lucnodes.com/api/bots/${id}/economia/removemoney/${servidor}/${usuario}/${cantidad}`, {
                method: 'post',
                headers: {
                    Authorization: token
                }
        ...
        let embed = {
            description: `Se ha eliminado ${cantidad} monedas a ${user} (${usuario})`,
            color: client.c.done
        }
